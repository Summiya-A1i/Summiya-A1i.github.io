...
### 📚 Academics & Society Vibes

Transitioning to studying from online resources was a huge shift from high school! 💻✨ Suddenly, my laptop became my entire world. Honestly, Calculus and Applied Physics have been a bit of a villain arc for me since I’ve never been math's favorite child 📖🙄, but I’m pushing through! 💅 Beyond classes, the campus vibe really picked up with society events like *IEEE*. Seeing everyone talk about their skills made me realize that engineering is all about the community you build! 🏛️🌷
<br>
<div style="text-align: center;">
    <img src="{{ site.baseurl }}/assets/images/ieee_day.jpeg" 
         style="width: 280px; height: 350px; object-fit: cover; border-radius: 20px; border: 2px solid var(--pink); box-shadow: 0 0 20px rgba(255, 105, 180, 0.4);">
    <p style="font-style: italic; color: #888; margin-top: 10px;">✨ My first IEEE Day at UET FSD! 🏛️🌸</p>
</div>
<br>
### 🐍 Python Lab Lore (PF with Dr. Bilal)
